...
\section{Model Formulation}\label{sec:model}
    ...
    The net work executed by the system during the $i$-th  subprocess,  $W_i$,  is  obtained  by  integration  of  the  $i$-th  locally  polytropic  process,  $P_iV_i^{n_i}  =  \mathbb{C}_i  =
