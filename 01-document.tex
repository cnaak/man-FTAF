...
\section{Model Formulation}\label{sec:model}
    ...
    \begin{table*}[ht]
        ...
        \begin{tabular}{ccc}
            \toprule
            $\quad{n_k}\quad$   & air-rich, $\phi \leqslant 1$      & fuel-rich, $\phi > 1$     \\
            \midrule
            \NCOO   & $\NC\NF \;=\; \NC\dfrac{\phi\epsilon}{1+\psi}\NA$
                    & $\NC\NF - c \;=\; \NC\dfrac{\phi\epsilon}{1+\psi}\NA - c$  \\[\bigskipamount]
            \NHHO   & $\frac{\NH}{2}\NF \;=\; \dfrac{\NH}{2}\frac{\phi\epsilon}{1+\psi}\NA$
                    & $(\NO-2\NC)\NF + \dfrac{2}{1+\psi}\NA + c$ \\[\bigskipamount]
            \NCO    & $0$
                    & $c$ \\[\bigskipamount]
            \NHH    & $0$
                    & $\quad\dfrac{2(\phi-1)}{\phi\epsilon}\NF - c \;=\; \dfrac{2(\phi-1)}{1+\psi}\NA - c\quad$ \\[\bigskipamount]
