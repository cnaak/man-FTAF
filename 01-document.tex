...
\begin{tabbing}\hspace*{\lensymb}\=\hspace*{\lenwhat}\=\hspace*{\lendefn}\kill
    ...
    \tcs{c}                 \> \tcw{Chemical amount for the \ce{CO}, \kilo\mole,}                                                               \> \tcd{Tab.~\ref{tab:molBal}}              \\
...
\begin{tabbing}\hspace*{\lensymb}\=\hspace*{\lenwhat}\=\hspace*{\lendefn}\kill
    ...
    \tcs{\epsilon}          \> \tcW{Amount of fuel per {\kilo\mole} of \ce{O2} that is stoichiometrically oxidized with\-out forming Nitrogen
                                    oxides, \kilo\mole,}                                                                                        \> \tcd{Eq.~(\ref{eq:epsilon})}             \\
...
\section{Model Formulation}\label{sec:model}
    ...
    By hypothesis, the combustion goes to completion whenever possible, i.e., whenever $\phi \leqslant 1$, so that Carbon and Hydrogen are fully  oxidized  into  \ce{CO2}  and  into  \ce{H2O},
    leaving no room for formation of \ce{CO} and of \ce{H2} products. On the other hand, whenever $\phi > 1$, completion hypothesis mean all  \ce{O2}  is  used  up  for  complete  and  partial
    oxidation of fuel Carbon and Hydrogen, leaving no room for residual \ce{O2} in the products.
    ...
    \begin{table*}[ht]
        ...
        \begin{tabular}{ccc}
            ...
            \midrule
            \NCOO   & $\NC\NF = \NC\frac{\phi\epsilon}{1+\psi}\NA$
                    & $\NC\NF - c = \NC\frac{\phi\epsilon}{1+\psi}\NA - c$  \\[\medskipamount]
            \NHHO   & $\frac{\NH}{2}\NF = \frac{\NH}{2}\frac{\phi\epsilon}{1+\psi}\NA$
                    & $(\NO-2\NC)\NF + \frac{2}{1+\psi}\NA + c$ \\[\medskipamount]
            \NCO    & $0$
                    & $c$ \\[\medskipamount]
            \NHH    & $0$
                    & $\frac{2(\phi-1)}{\phi\epsilon}\NF - c = \frac{2(\phi-1)}{1+\psi}\NA - c$ \\[\medskipamount]
            \NOO    & $(1-\phi)\frac{\NA}{1+\psi} = (1-\phi)\frac{\NF}{\phi\epsilon}$
                    & $0$ \\[\medskipamount]
            \NNN    & $\frac{\psi}{1+\psi}\NA + \frac{\NN}{2}\NF$
                    & $\frac{\psi}{1+\psi}\NA + \frac{\NN}{2}\NF$ \\
            \bottomrule
        \end{tabular}
        \label{tab:molBal}
    \end{table*}
