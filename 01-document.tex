...
\section{Model Formulation}
    ...
    %
    \begin{equation}
        \mathrm{mf}_k = \frac{m_k}{m_m}, \quad
        \mathrm{y}_k = \frac{n_k}{n_m}, \quad
        m_m = \sum_{k=1}^p m_k, \quad
        \mbox{and}\quad
        n_m = \sum_{k=1}^p n_k,
        \label{eq:mfy}
    \end{equation}
    ...
    $m$ and $n$ are mass, \kilogram, and quantity of matter, \kilo\mole, respectively.
