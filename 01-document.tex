...
\begin{tabbing}\hspace*{\lensymb}\=\hspace*{\lenwhat}\=\hspace*{\lendefn}\kill
    ...
    \tcs{\mathsf{n}}        \> \tcw{Subprocess polytropic exponent, ---,}                                                               \> \tcd{Eq.~(\ref{eq:Wi})}                          \\
...
\section{Model Formulation}\label{sec:model}
    ...
    next section illustrates one possible, however very helpful, thermodynamic library implementation to be handed to students.
