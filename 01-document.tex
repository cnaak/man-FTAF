    ...
    \begin{table*}[ht]
        ...
        \begin{tabular}{ccc}
            ...
            \NCOO   & $\NC\NF \;=\; \NC\dfrac{\phi\epsilon}{1+\psi}\NA$
                    & $\NC\NF - c \;=\; \NC\dfrac{\phi\epsilon}{1+\psi}\NA - c$  \\[\medskipamount]
            \NHHO   & $\frac{\NH}{2}\NF = \dfrac{\NH}{2}\frac{\phi\epsilon}{1+\psi}\NA$
                    & $(\NO-2\NC)\NF + \dfrac{2}{1+\psi}\NA + c$ \\[\medskipamount]
            \NCO    & $0$
                    & $c$ \\[\medskipamount]
            \NHH    & $0$
                    & $\dfrac{2(\phi-1)}{\phi\epsilon}\NF - c = \dfrac{2(\phi-1)}{1+\psi}\NA - c$ \\[\medskipamount]
            \NOO    & $(1-\phi)\dfrac{\NA}{1+\psi} = (1-\phi)\dfrac{\NF}{\phi\epsilon}$
                    & $0$ \\[\medskipamount]
