...
{\em Latin symbols:} \\
    ...
    \tcs{\bar{c}}     \> \tcw{Molar-base specific heat,
                            \kilo\joule\per\kilo\mole\usk\kelvin,}                      \> \tcw{Eq.~(\ref{eq:cp})           \\
    \tcs{D}           \> \tcw{Piston diameter, \meter,}                                        \> \tcw{Eq.~(\ref{eq:S})                  \\
    \tcs{\bar{h}}     \> \tcw{Molar-base specific enthalpy, \kilo\joule\per\kilo\mole,}   \> \tcd{Eq.~(\ref{eq:H.comp})}      \\
    \tcs{H}           \> \tcw{Enthalpy, \kilo\joule,}                                          \> \tcw{Eq.~(\ref{eq:H.comp})             \\
    \tcs{k}           \> \tcw{Mixture component index, ---,}                                   \> \tcw{Sec.~\ref{sec:model.reactm}       \\
    \tcs{L}           \> \tcw{Connecting rod length, \meter,}                                  \> \tcw{Eq.~(\ref{eq:x})                  \\
    \tcs{m}           \> \tcw{Mass, \kilogram,}                                                \> \tcw{Eq.~(\ref{eq:mf})                 \\
    \tcs{\mathbb{M}}  \> \tcw{Mixture, ---,}                                                   \> \tcw{Eq.~(\ref{eq:?})                  \\
    \tcs{\mathrm{mf}} \> \tcw{Mass fraction, ---,}                                             \> \tcw{Eq.~(\ref{eq:mf})                 \\
    \tcs{n}           \> \tcw{Chemical amount, \kilo\mole,}                                    \> \tcw{Eq.~(\ref{eq:nm})                 \\
    \tcs{n}           \> \tcw{Fuel composition parameter, \kilo\mole,}                         \> \tcw{Eq.~(\ref{eq:epsilon})            \\
    \tcs{N}           \> \tcw{Engine's rotation, RPM,}                                         \> \tcw{Sec.~\ref{sec:model.engine}       \\
    \tcs{p}           \> \tcw{Mixture component count, ---,}                                   \> \tcw{Sec.~\ref{sec:model.reactm}       \\
    \tcs{P}           \> \tcw{Thermodynamic pressure, \kilo\pascal,}                           \> \tcw{Eq.~(\ref{eq:?})                  \\
    \tcs{r}           \> \tcw{Ratio (engine compression), ---,}                                \> \tcw{Eq.~(\ref{eq:r})                  \\
    \tcs{R}           \> \tcw{Crank radius, \meter,}                                           \> \tcw{Eq.~(\ref{eq:S})                  \\
    \tcs{\bar{R}}     \> \tcw{The universal gas constant, \kilo\joule\per\kilo\mole\usk\kelvin,} \> \tcw{Sec.~\ref{sec:model.reactm}       \\
    \tcs{S}           \> \tcw{Piston stroke, \meter,}                                          \> \tcw{Eq.~(\ref{eq:S})                  \\
    \tcs{t}           \> \tcw{Time, \second,}                                                  \> \tcw{Sec.~\ref{sec:model.engine}       \\
    \tcs{T}           \> \tcw{Thermodynamic temperature, \kelvin,}                             \> \tcw{Eq.~(\ref{eq:cp})                 \\
    \tcs{\bar{u}}     \> \tcw{Molar-base specific internal energy,
                      \kilo\joule\per\kilo\mole,}                                      \> \tcw{Eq.~(\ref{eq:U.comp})             \\
    \tcs{U}           \> \tcw{Internal energy, \kilo\joule,}                                   \> \tcw{Eq.~(\ref{eq:U.comp})             \\
    \tcs{v}           \> \tcw{Mass-base specific volume, \meter\cubed\per\kilogram,}           \> \tcw{Eq.~(\ref{eq:?})                  \\
    \tcs{V}           \> \tcw{Volume, \meter\cubed,}                                           \> \tcw{Eqs.~(\ref{eq:S}), (\ref{eq:V})   \\
    \tcs{w}           \> \tcw{Uncertainty of, (variable),}                                     \> \tcw{Eq.~(\ref{eq:cp})                 \\
    \tcs{\mathrm{y}}  \> \tcw{Molar fraction, ---,}                                            \> \tcw{Eq.~(\ref{eq:y})                  \\
    \tcs{z}           \> \tcw{Engine's cylinder count, ---,}                                   \> \tcw{Sec.~\ref{sec:model.engine}       \\
\end{tabbing}
...
\section{Model Formulation}\label{sec:model}
    ...
    non-carbon   fuels,   such   as   Hydrogen,    \ce{H2},    or    Hydrazine,    \ce{H2N2},    from    being    employed    in
    simulations~\cite{2018-SilvaRKO-UTFPR}.

    The air is modeled as a mixture of \ce{O2} and of \ce{N2} gases with a proportion of  $\psi$  {\kilo\mole}  of  \ce{N2}  per
    {\kilo\mole} of \ce{O2}. As the Nitrogen will be kept inert, all inert gases are modeled as  \ce{N2}.  A  typical  value  of
    $\psi$ is $79/21 \approx 3.76$.

    Fuel is generically modeled as a \ce{C\NC H\NH O\NO N\NN} mol\-e\-cule, in which \NC, \NH, \NO,  and  {\NN}  are  adjustable
    parameters. Let $\epsilon$ be the amount of fuel per {\kilo\mole} of \ce{O2} that  is  stoichiometrically  oxidized  without
