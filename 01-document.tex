...
\section{Model Formulation}\label{sec:model}
    ...
    \end{align}
    %
    \noindent which clearly shows the distinction between heat transfer interactions (for instance, with the engine block), and internal energy generation due to chemical reaction, in which%
    %
    \begin{align}
